                ...
                <tr>
                    <td>
                        ...
                        <table class="slider" align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tbody>
                                <tr>
                                    <th align="center" width="40%"><img src="{{ asset('assets/images/email-template/slider.jpg') }}" alt="" style="margin-bottom: -5px;" /></th>
                                ...
                                <tr>
                                    <td>
                                        <div class="product-box hover">
                                            <div class="product border-theme br-0"><img src="{{ asset('assets/images/email-template/7.jpg') }}" alt="product" style="width: 100%;" /></div>
                                    ...
                                    <td>
                                        <div class="product-box hover">
                                            <div class="product border-theme br-0"><img src="{{ asset('assets/images/email-template/8.jpg') }}" alt="product" style="width: 100%;" /></div>
                                            <div class="product-info">
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" align="center" style="margin-top: 30px;">
                            <tbody>
                                <tr class="add-with-banner" align="center">
                                    <td>
                                        <a href="javascript:void(0)"><img src="{{ asset('assets/images/email-template/banner.jpg') }}" alt="product" style="width: 100%;" /></a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                        <table border="0" cellpadding="0" cellspacing="0" align="center" style="margin-top: 30px;">
                            <tbody>
                                <tr>
                                    <td><img src="{{ asset('assets/images/email-template/banner-2.jpg') }}" alt="" style="width: 100%;" /></td>
                                </tr>
                            </tbody>
                        </table>
                        <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-top: 30px;">
                                ...
                                <tr>
                                    <td align="center">
                                        <table class="display-width-inner" align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 450px;">
                                            <tbody>
                                                <tr>
                                                    <td align="center" style="width: 40%;"><img src="{{ asset('assets/images/email-template/10.jpg') }}" alt="" style="width: 225px; margin-bottom: -4px;" /></td>
                                        ...
                                        <table class="display-width-inner" align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 450px;">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td align="center" style="width: 40%;"><img src="{{ asset('assets/images/email-template/11.jpg') }}" alt="" style="width: 225px; margin-bottom: -4px;" /></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        <table class="display-width-inner" align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 450px;">
                                            <tbody>
                                                <tr>
                                                    <td align="center" style="width: 40%;"><img src="{{ asset('assets/images/email-template/12.jpg') }}" alt="" style="width: 225px; margin-bottom: -4px;" /></td>
                                                    <td align="center" style="background-color: #fafafa; width: 60%;">
                                                        <h3 style="margin: 0;">Product One</h3>
                                                        <div style="color: #e01931; font-weight: 600; font-size: 16px; line-height: 27px; letter-spacing: 1px; margin: 4px;">
                                                            <span
