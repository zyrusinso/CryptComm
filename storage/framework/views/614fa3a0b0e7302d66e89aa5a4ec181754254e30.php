...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> 
        <?php echo e(__('app.profile.browser_session')); ?>

     <?php $__env->endSlot(); ?>

     <?php $__env->slot('description', null, []); ?> 
        <?php echo e(__('app.profile.manage_logout')); ?>
...
<?php $component->withAttributes(['on' => 'loggedOut']); ?>
            <?php echo e(__('app.profile.done')); ?>
...
<?php endif; ?>
        ...
        <div>
            <?php echo e(__('app.profile.if_necessary')); ?>
                            ...
                            <div>
                                <div class="small font-weight-lighter text-muted">
                                    ...
                                    <?php if($session->is_current_device): ?>
                                        <span class="text-success font-weight-bold"><?php echo e(__('app.profile.this_device')); ?></span>
                                    <?php else: ?>
...
<?php $component->withAttributes(['wire:click' => 'confirmLogout','wire:loading.attr' => 'disabled']); ?>
                <?php echo e(__('app.profile.logout_others')); ?>
...
<?php $component->withAttributes(['wire:model' => 'confirmingLogout']); ?>
             ...
             <?php $__env->slot('content', null, []); ?> 
                <?php echo e(__('app.profile.please_enter')); ?>
...
<?php endif; ?>
                ...
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.button','data' => ['class' => 'ms-2','wire:click' => 'logoutOtherBrowserSessions','wire:loading.attr' => 'disabled']]); ?>
<?php $component->withName('jet-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['class' => 'ms-2','wire:click' => 'logoutOtherBrowserSessions','wire:loading.attr' => 'disabled']); ?>
                    <?php echo e(__('app.profile.logout_others')); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php /**PATH G:\xampp\htdocs\Laravel\Ecomm\resources\views/profile/logout-other-browser-sessions-form.blade.php ENDPATH**/ ?>