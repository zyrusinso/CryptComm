                ...
                <div id="mainnav">
                    <ul class="nav-menu custom-scrollbar">
                        ...
                        <li class="sidebar-main-title">
                            <div>
                                <h6><?php echo app('translator')->get('app.sidebar.general'); ?></h6>
                            </div>
                        </li>
                        <li class="dropdown">
                    ...
                    <ul class="nav-menu custom-scrollbar">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="nav-submenu menu-content" style="display: <?php echo e(prefixBlock('ecommerce')); ?>;">
                                ...
                                <li><a href="<?php echo e(route('cart.index')); ?>" class="<?php echo e(routeActive('cart.index')); ?>"><?php echo app('translator')->get('app.cart'); ?></a></li>
                                <li><a href="<?php echo e(route('order.index')); ?>" class="<?php echo e(routeActive('order.index')); ?>"><?php echo app('translator')->get('app.sidebar.order'); ?></a></li>
                            </ul>
                        </li>
                        

                        <li class="dropdown">
                            <a class="nav-link menu-title link-nav <?php echo e(routeActive('blogs.index')); ?>" href="<?php echo e(route('blogs.index')); ?>"><i data-feather="edit"></i><span><?php echo app('translator')->get('app._blog'); ?></span></a>
                        </li>
                        ...
                        <li class="dropdown">
                            <a class="nav-link menu-title link-nav <?php echo e(routeActive('privacy-policy.index')); ?>" href="<?php echo e(route('privacy-policy.index')); ?>"><i data-feather="link"></i><span><?php echo app('translator')->get('app.privacy_policy'); ?></span></a>
                        </li>
                        <li class="dropdown">
...
<?php /**PATH G:\xampp\htdocs\Laravel\Ecomm\resources\views/layouts/partials/sidebar.blade.php ENDPATH**/ ?>