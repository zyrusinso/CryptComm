	                                ...
	                                <div class="profile-title">
	                                    <div class="media">
	                                        ...
	                                        <div class="media-body">
	                                            <h3 class="mb-1 f-20 txt-primary">YOUR NAME</h3>
	                                            <p class="f-12">User</p>
	                                        </div>
	                                    </div>
	                                </div>
	                        ...
	                        <div class="row">
                                <div class="col-sm-6 col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" rows="5">Simple Description or bio about the user</textarea>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-3">
                                    <div class="mb-3">
