      ...
      <div class="logo-wrapper" style="margin-left: 15px;">
        ...
        <div class="d-flex justify-content-center items-center">
          ...
          <div class="d-flex flex-column text-center headTitle" style="margin-left: 5px; margin-top: 3px;">
            ...
            <span style="margin-top: -13px;" class="header-description">(<?php echo e(__('app.header.description')); ?>)</span>
          </div>
        </div>
      </div>
    ...
    <div class="nav-right col pull-right right-menu p-0">
      <ul class="nav-menus">
        ...
        <?php if(session()->get("locale") == 'en'): ?>
          <li>
            <a class="text-dark" href="<?php echo e(route('setLang', 'ph')); ?>">
...
<form id="logout-form" action="<?php echo e(route('logout')); ?>" method="POST" class="d-none">
  <?php echo csrf_field(); ?>
</form><?php /**PATH G:\xampp\htdocs\Laravel\Cryptcomm\resources\views/layouts/partials/header.blade.php ENDPATH**/ ?>