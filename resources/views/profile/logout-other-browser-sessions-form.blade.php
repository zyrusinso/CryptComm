<x-jet-action-section>
    <x-slot name="title">
        {{ __('app.profile.browser_session') }}
    </x-slot>

    <x-slot name="description">
        {{ __('app.profile.manage_logout') }}
    </x-slot>
                            ...
                            <div>
                                <div class="small font-weight-lighter text-muted">
                                    ...
                                    @if ($session->is_current_device)
                                        <span class="text-success font-weight-bold">{{ __('app.profile.this_device') }}</span>
                                    @else
